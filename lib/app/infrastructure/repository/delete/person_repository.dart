...
import 'package:rick_and_morty_test_restapi/app/core/common/base/query/base_exception.dart';
...
class PersonRestRepository implements PersonListBaseRepository {
  ...
  Future<PersonDetailModel> getPerson(int id) async {
    ...
    if (response.statusCode == 200) {
      //var jsonResponse = jsonDecode(response.body);
      PersonDetailModel ret = PersonDetailModel.fromJson(
